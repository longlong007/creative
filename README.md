...
3. 云开发控制台创建集合：`xiaoya_users`、`xiaoya_families`、`xiaoya_members`、`xiaoya_babies`、`xiaoya_records`（字段说明见 `database/README.md`）
4. 上传并部署云函数：`xiaoyaLogin`、`createFamily`、`joinFamily`、`leaveFamily`、`manageRecord`、`manageFamily`、`aiAnalyze`
